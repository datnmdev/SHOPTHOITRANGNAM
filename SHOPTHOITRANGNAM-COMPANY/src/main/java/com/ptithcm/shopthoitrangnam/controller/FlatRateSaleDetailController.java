...
public class FlatRateSaleDetailController {
	...
	public String createFlatRateSaleDetailPage(Model model, @RequestParam("flat-rate-sale-id") Integer flatRateSaleId) {
		...
		List<ProductDetail> productDetailsInFlatRateSaleDetails = flatRateSaleDetailService.findByFlatRateSale(flatRateSaleService.findByFlatRateSaleId(flatRateSaleId).get()).stream().map(flatRateSaleDetail -> flatRateSaleDetail.getProductDetail()).toList();
	...
	public String createFlatRateSaleDetail(@Valid @ModelAttribute(name = "flatRateSaleDetailDto") FlatRateSaleDetailDto flatRateSaleDetailDto, BindingResult bindingResult, Model model) {
		...
		List<ProductDetail> productDetailsInFlatRateSaleDetails = flatRateSaleDetailService.findByFlatRateSale(flatRateSaleService.findByFlatRateSaleId(flatRateSaleDetailDto.getFlatRateSaleId()).get()).stream().map(flatRateSaleDetail -> flatRateSaleDetail.getProductDetail()).toList();
		List<ProductDetail> productDetails = productDetailService.findAll();
		productDetails.removeAll(productDetailsInFlatRateSaleDetails);
		model.addAttribute("productDetails", productDetails);
